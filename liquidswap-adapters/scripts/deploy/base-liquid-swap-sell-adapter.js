...
async function main() {
  console.log("Deploying TestLiquidSwapSellAdapter...");
  ...
  const TestLiquidSwapBuyAdapter = await hre.ethers.getContractFactory("TestLiquidSwapSellAdapter");

  console.log("Starting deployment...");
  const adapter = await TestLiquidSwapBuyAdapter.deploy(
  ...
  console.log(`TestLiquidSwapSellAdapter deployed to: ${adapterAddress}`);
