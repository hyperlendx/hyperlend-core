...
async function main() {
  console.log("Deploying TestLiquidSwapBuyAdapter...");
  ...
  const TestLiquidSwapBuyAdapter = await hre.ethers.getContractFactory("TestLiquidSwapBuyAdapter");
  ...
  console.log(`TestLiquidSwapBuyAdapter deployed to: ${adapterAddress}`);
