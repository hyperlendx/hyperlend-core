...
import {DataTypes} from 'hyperlend-core/src/contracts/protocol/libraries/types/DataTypes.sol';
import {FlashLoanSimpleReceiverBase} from 'hyperlend-core/src/contracts/misc/flashloan/base/FlashLoanSimpleReceiverBase.sol';
import {GPv2SafeERC20} from 'hyperlend-core/src/contracts/dependencies/gnosis/contracts/GPv2SafeERC20.sol';
import {IERC20} from 'hyperlend-core/src/contracts/dependencies/openzeppelin/contracts/IERC20.sol';
import {IERC20Detailed} from 'hyperlend-core/src/contracts/dependencies/openzeppelin/contracts/IERC20Detailed.sol';
import {IERC20WithPermit} from 'hyperlend-core/src/contracts/interfaces/IERC20WithPermit.sol';
import {IPoolAddressesProvider} from 'hyperlend-core/src/contracts/interfaces/IPoolAddressesProvider.sol';
import {IPriceOracleGetter} from 'hyperlend-core/src/contracts/interfaces/IPriceOracleGetter.sol';
import {SafeMath} from 'hyperlend-core/src/contracts/dependencies/openzeppelin/contracts/SafeMath.sol';
import {Ownable} from 'hyperlend-core/src/contracts/dependencies/openzeppelin/contracts/Ownable.sol';
